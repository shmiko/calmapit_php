    ...
    <div class="col-sm-12 col-md-12">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6">
                <p><input class="ttip_r form-control" title=".ttip_r" placeholder="right center" type="text"></p>
                <p><input class="ttip_l form-control" title=".ttip_l" placeholder="left center" type="text"></p>
                <p><input class="ttip_t form-control" title=".ttip_t" placeholder="top center" type="text"></p>
                <p><input class="ttip_b form-control" title=".ttip_b" placeholder="bottom center" type="text"></p>
            </div>
            <div class="col-sm-6 col-md-6">
...
<div class="row">
    <div class="col-sm-12 col-md-12">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6">
                <p><a href="#" class="pop_over" data-content="Lorem ipsum dolor sit amet, consectetur adipiscing elit" title="Lorem ipsum" data-placement="right">Lorem ipsum</a> dolor sit amet, consectetur adipiscing elit. Nam id turpis ut magna mattis <a href="#" class="pop_over" data-content="Lorem ipsum dolor sit amet, consectetur adipiscing elit" title="Lorem ipsum" data-placement="left">dignissim sed</a> eget quam. Aenean congue sem at augue tincidunt sagittis. Donec <a href="#" class="pop_over" data-content="Lorem ipsum dolor sit amet, consectetur adipiscing elit" title="Lorem ipsum" data-placement="top">vitae magna</a> blandit ipsum lacinia dapibus. Sed lectus dui, imperdiet sed <a href="#" class="pop_over" data-content="Lorem ipsum dolor sit amet, consectetur adipiscing elit" title="Lorem ipsum" data-placement="bottom">auctor faucibus</a>, convallis nec magna…</p>
            </div>
            <div class="col-sm-6 col-md-6">
                <p><a href="#" class="btn pop_over btn-default" data-content="Lorem ipsum dolor sit amet, consectetur adipiscing elit" title="Lorem ipsum" data-placement="right">click for popover (right)</a></p>
                <p><a href="#" class="btn pop_over btn-default" data-content="Lorem ipsum dolor sit amet, consectetur adipiscing elit" title="Lorem ipsum" data-placement="left">click for popover (left)</a></p>
                <p><a href="#" class="btn pop_over btn-default" data-content="Lorem ipsum dolor sit amet, consectetur adipiscing elit" title="Lorem ipsum" data-placement="top">click for popover (top)</a></p>
                <p><a href="#" class="btn pop_over btn-default" data-content="Lorem ipsum dolor sit amet, consectetur adipiscing elit" title="Lorem ipsum" data-placement="bottom">click for popover (bottom)</a></p>
            </div>
        </div>
	</div>
</div>
<div class="row">
    <div class="col-sm-12 col-md-12">
        <h3 class="heading">Hint.css</h3>
        <div class="row">
            <div class="col-sm-4 col-md-4">
                <p><a href="#" class="hint--top" data-hint="Lorem ipsum dolor sit...">Top Toolip</a></p>
                <p><a href="#" class="hint--right" data-hint="Lorem ipsum dolor sit...">Right Tooltip</a></p>
                <p><a href="#" class="hint--bottom" data-hint="Lorem ipsum dolor sit...">Bottom tooltip</a></p>
                <p><a href="#" class="hint--left" data-hint="Lorem ipsum dolor sit...">Left Tooltip</a></p>
                <p><a class="hint--right" data-hint="Lorem ipsum dolor sit..." href="#"><img src="gallery/Image08_tn.jpg" alt="" class="img-thumbnail"></a></p>
            </div>
            <div class="col-sm-4 col-md-4">
                <p><a href="#" class="hint--top  hint--error" data-hint="Lorem ipsum dolor sit...">Error Tooltip</a></p>
                <p><a href="#" class="hint--left  hint--warning" data-hint="Lorem ipsum dolor sit...">Warning Tooltip</a></p>
                <p><a href="#" class="hint--right  hint--info" data-hint="Lorem ipsum dolor sit...">Info Tooltip</a></p>
                <p><a href="#" class="hint--bottom  hint--success" data-hint="Lorem ipsum dolor sit...">Success Tooltip</a></p>
            </div>
            <div class="col-sm-4 col-md-4">
                <p><a href="#" class="hint--left hint--always" data-hint="Lorem ipsum dolor sit...">Persistent tooltip</a></p>
                <p><a href="#" class="hint--top  hint--rounded" data-hint="Lorem ipsum dolor sit...">Rounded corners</a></p>
            </div>
        </div>
	</div>
</div>                </div>
