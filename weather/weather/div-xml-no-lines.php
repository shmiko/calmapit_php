...
<title>Google Maps Events | Demo: Simple Div without Directions or Polylines (with Geocoding)</title>
<!--JAVASCRIPTS START-->
<!--map files-->
...
<script type="text/javascript" src="js/div-no-lines.js"></script>
<!--JAVASCRIPTS END-->
...
<div class="header">
Google Maps Events
<p>Demo: Simple Div without Directions or Polylines (with Geocoding)</p>
</div>
