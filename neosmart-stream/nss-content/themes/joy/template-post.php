...
$out .= <<<EOD
	<div id="nss-item-$position" data-id="$id" data-timestamp="$timestamp" class="nss-item nss-$channel $item_class">
		<div class="nss-head">
			<div class="nss-channel-icon"></div>
...
switch($extras_facebook_type){
	case 'photo':
		$out .= "<a class='nss-facebook-photo-link' href='$extras_facebook_link' target='_blank'><img class='nss-facebook-picture' src='$extras_facebook_image_600' alt='' border='0'></a>";
	...
	break;
	case 'video':
		$out .= "<div class='nss-facebook-iframe'><iframe class='nss-facebook-video' width='400' height='300' src='$extras_facebook_source'></iframe></div>";
		$out .= "<div class='nss-facebook-name'>$extras_facebook_name</div>";
		$out .= "<div class='nss-facebook-message'>$extras_facebook_message</div>";
	break;
	case 'link':
		...
		$out .= "<div class='nss-facebook-name'>$extras_facebook_name</div>";
		$out .= "<div class='nss-facebook-description'>$extras_facebook_description</div>";
		if($extras_facebook_image_600) $out .= "<a class='nss-facebook-photo-link' href=\"$extras_facebook_link\" target='_blank'><img class='nss-facebook-picture' src='$extras_facebook_image_600' alt=\"$extras_facebook_link\" border='0'></a>";
...
$out .= <<<EOD
	<div class="nss-facebook-comments">
		<div class="nss-facebook-count-comments">$extras_facebook_count_comments</div>
