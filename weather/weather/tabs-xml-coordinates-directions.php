...
<title>Google Maps Events | Demo: Tabs with Directions and Coordinates</title>
<!--JAVASCRIPTS START-->
<!--map files-->
...
<script type="text/javascript" src="js/tabs-coordinates-directions.js"></script>
<!--JAVASCRIPTS END-->

<!--MAP STYLE-->
<link type="text/css" href="css/mapStyle.css" rel="stylesheet" type="text/css" media="all" />
...
<div class="header">
Google Maps Events
<p>Demo: Tabs with Directions and Coordinates</p>
</div>
