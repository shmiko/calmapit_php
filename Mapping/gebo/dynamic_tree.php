...
<html lang="en">
    ...
    <div class="col-sm-4 col-md-4">
        <div id="tree_a">
            <ul style="display: none;">
                <li id="a_id1">item1</li>
                <li id="a_id2" class="folder expanded">
                    item2
                    <ul>
                        <li id="a_id2.1">Sub item 2.1</li>
                        <li id="a_id2.2">Sub item 2.2</li>
                        <li id="a_id2.3" class="folder expanded">
                            Sub-item 2.3
                            <ul>
                                <li id="a_id2.3.1">Sub-item 2.3.1</li>
                                <li id="a_id2.3.1">Sub-item 2.3.2</li>
                                <li id="a_id2.3.1">Sub-item 2.3.3</li>
                                <li id="a_id2.3.1">Sub-item 2.3.4</li>
                            </ul>
                        </li>
                    </ul>
                </li>
                <li id="a_id3" class="folder expanded">
                    Folder with some children
                    <ul>
                        <li id="a_id3.1" class="expanded">
                            Sub-item 3.1
                            <ul>
                                <li id="a_id3.1.1">Sub-item 3.1.1</li>
                                <li id="a_id3.1.2">Sub-item 3.1.2</li>
                            </ul>
                        </li>
                        <li id="a_id3.2">
                            Sub-item 3.2
                            <ul>
                                <li id="a_id3.2.1">Sub-item 3.2.1</li>
                                <li id="a_id3.2.2">Sub-item 3.2.2</li>
                            </ul>
                        </li>
                    </ul>
                </li>
                <li id="a_id4" class="expanded">
                    Document with some children (expanded on init)
                    <ul>
                        <li id="a_id4.1" class="active focused">Sub-item 4.1 (active and focus on init)
                            <ul>
                                <li id="a_id4.1.1">Sub-item 4.1.1</li>
                                <li id="a_id4.1.2">Sub-item 4.1.2</li>
                            </ul>
                        </li>
                        <li id="a_id4.2">Sub-item 4.2
                            <ul>
                                <li id="a_id4.2.1">Sub-item 4.2.1</li>
                                <li id="a_id4.2.2">Sub-item 4.2.2</li>
                            </ul>
                        </li>
                    </ul>
                </li>
    ...
    <div class="col-sm-4 col-md-4">
        <div id="tree_b">
            <ul style="display: none;">
                <li id="b_id2">item1</li>
                <li id="b_id3" class="folder expanded">
                    Folder with some children
                    <ul>
                        <li id="b_id3.1">Sub-item 3.1
                            <ul>
                                <li id="b_id3.1.1">Sub-item 3.1.1</li>
                                <li id="b_id3.1.2">Sub-item 3.1.2</li>
                            </ul>
                        </li>
                        <li id="b_id3.2" class="expanded">
                            Sub-item 3.2
                            <ul>
                                <li id="b_id3.2.1">Sub-item 3.2.1</li>
                                <li id="b_id3.2.2">Sub-item 3.2.2</li>
                            </ul>
                        </li>
                    </ul>
                </li>
                <li id="b_id4" class="expanded">
                    Document with some children (expanded on init)
                    <ul>
                        <li id="b_id4.1" class="active focused">
                            Sub-item 4.1 (active and focus on init)
                            <ul>
                                <li id="b_id4.1.1">Sub-item 4.1.1</li>
                                <li id="b_id4.1.2">Sub-item 4.1.2</li>
                            </ul>
                        </li>
                        <li id="b_id4.2">
                            Sub-item 4.2
                            <ul>
                                <li id="b_id4.2.1">Sub-item 4.2.1</li>
                                <li id="b_id4.2.2">Sub-item 4.2.2</li>
                            </ul>
                        </li>
                    </ul>
                </li>
        ...
        <div id="tree_b_echoSelection" style="padding-top:10px">Selection: <pre> --- </pre></div>
    </div>
    <div class="col-sm-4 col-md-4">
        <div id="tree_c">
            <ul style="display: none;">
                <li id="c_id2" data="unselectable:true">item1</li>
                <li id="c_id3" class="folder">
                    Folder with some children
                    <ul>
                        <li id="c_id3.1">
                            Sub-item 3.1
                            <ul>
                                <li id="c_id3.1.1">Sub-item 3.1.1</li>
                                <li id="c_id3.1.2">Sub-item 3.1.2</li>
                            </ul>
                        </li>
                        <li id="c_id3.2">
                            Sub-item 3.2
                            <ul>
                                <li id="c_id3.2.1">Sub-item 3.2.1</li>
                                <li id="c_id3.2.2">Sub-item 3.2.2</li>
                            </ul>
                        </li>
                    </ul>
                </li>
                <li id="c_id4" class="expanded">
                    Document with some children (expanded on init)
                    <ul>
                        <li id="c_id4.1" class="active focused">
                            Sub-item 4.1 (active and focus on init)
                            <ul>
                                <li id="c_id4.1.1">Sub-item 4.1.1</li>
                                <li id="c_id4.1.2">Sub-item 4.1.2</li>
                            </ul>
                        </li>
                        <li id="c_id4.2" class="expanded">Sub-item 4.2
                            <ul>
                                <li id="c_id4.2.1">Sub-item 4.2.1</li>
                                <li id="c_id4.2.2">Sub-item 4.2.2</li>
                            </ul>
                        </li>
                    </ul>
                </li>
        ...
        <div id="tree_c_echoSelection" style="padding-top:10px">Selection: <pre> --- </pre></div>
    </div>
</div>                </div>
            </div>
