...
<title>Google Maps Events | Demo: Accordion with Directions with Geocoding</title>
<!--JAVASCRIPTS START-->
<!--map files-->
...
<script type="text/javascript" src="js/accordion-directions.js"></script>
<!--JAVASCRIPTS END-->
...
<div class="header">
Google Maps Events
<p>Demo: Accordion with Directions with Geocoding</p>
</div>
