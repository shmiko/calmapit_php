...
<title>Google Maps Events | Demo: Accordion Weather</title>
<!--JAVASCRIPTS START-->
<!--map files-->
<script src="http://maps.google.com/maps/api/js?sensor=false&libraries=weather"></script>
...
//maps folder with slash at the end - no slash front of
var mapsFolder = '';

//xml file
var xmlFile = 'weather-xml.php?weau=';
...
var thisMapType = google.maps.MapTypeId.TERRAIN;

//****   END CONFIGURATION  ****//
</script>
<script type="text/javascript" src="js/accordion-weather.js"></script>
<!--JAVASCRIPTS END-->

<!--MAP STYLE-->
<link href="css/mapStyle-weather.css" rel="stylesheet" type="text/css" />
...
<div class="header">
Google Maps Events
<p>Demo: Accordion Weather</p>
</div>

<div class="outer">
<!--ACCORDION AND WEATHER MAP START HERE-->
	<div class="weaOuter">
		<div class="weaUnits"><a href="?units=C">&deg;C</a> <br />--<br /> <a href="?units=F">&deg;F</a><!--weather units links--></div>
		
		<div class="accordionMap"><!--place for accordion here--></div>

		<div id="map"><!--place for map here--></div>

		<div class="clearfix"></div>
		<div class="loading"><img src="images/loading.gif" /><br />loading weather data... please wait...</div>
	</div>
<!--ACCORDION AND WEATHER MAP END HERE-->

<div style="text-align:right;padding-top:3px;font-size:11px;color:#666;font-style:italic;">click on map icons for get city/location's detailed weather</div>		
</div>

<div class="links"><a href="./">&bull; Back to main page</a><br /><br />
<b>Other Demos:</b><br /><br />
With Coordinates:<br /><a href="accordion-xml-coordinates-polylines.php"> Accordion with Polylines</a> | 
...
With Geocoding:<br /><a href="accordion-xml-polylines.php"> Accordion with Polylines</a> | 
...
<a href="div-xml-no-lines.php"> Simple Div without Directions or Polylines</a><br />
</div>
