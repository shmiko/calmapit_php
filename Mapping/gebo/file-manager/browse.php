...
<link href="css.php?type=files" rel="stylesheet" type="text/css" />
...
browser.access = {"files":{"upload":false,"delete":false,"copy":false,"move":false,"rename":false},"dirs":{"create":false,"delete":false,"rename":false}};
browser.dir = "files";
browser.uploadURL = "/file-manager/upload";
browser.thumbsURL = browser.uploadURL + "/.thumbs";
browser.cms = "";
_.kuki.domain = "gebo-admin-3.tzdthemes.com";
_.kuki.path = "/";
