...
<title>Google Maps Events | Demo: Accordion without Directions or Polylines (with Geocoding)</title>
<!--JAVASCRIPTS START-->
<!--map files-->
...
<script type="text/javascript" src="js/tabs-no-lines.js"></script>
<!--JAVASCRIPTS END-->
...
<div class="header">
Google Maps Events
<p>Demo: Accordion without Directions or Polylines (with Geocoding)</p>
</div>
