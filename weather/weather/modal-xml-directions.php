...
<title>Google Maps Events | Demo: Modal Window with Directions with Geocoding</title>
<!--JAVASCRIPTS START-->
<!--map files-->
...
<script type="text/javascript" src="js/modal-directions.js"></script>
<!--JAVASCRIPTS END-->
...
<div class="header">
Google Maps Events
<p>Demo: Modal Window with Directions with Geocoding</p>
</div>
