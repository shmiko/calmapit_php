...
<title>Google Maps Events | Demo: Modal Window without Directions or Polylines (with Coordinates)</title>
<!--JAVASCRIPTS START-->
<!--map files-->
...
<script type="text/javascript" src="js/modal-coordinates-no-lines.js"></script>
<!--JAVASCRIPTS END-->
...
<div class="header">
Google Maps Events
<p>Demo: Modal Window without Directions or Polylines (with Coordinates)</p>
</div>
