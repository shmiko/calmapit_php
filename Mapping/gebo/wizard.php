                ...
                <form id="simple_wizard" class="stepy-wizzard form-horizontal">
                    <fieldset title="Personal info">
                        ...
                        <div class="formSep form-group">
                            <label for="s_username" class="col-md-2 control-label">Username:</label>
                            <div class="col-md-10">
								<input type="text" name="s_username" id="s_username" class="input-sm form-control">
							</div>
                        </div>
                        <div class="formSep form-group">
                            <label for="s_password" class="col-md-2 control-label">Password:</label>
                            <div class="col-md-10">
								<input type="password" name="s_password" id="s_password" class="input-sm form-control">
							</div>
                        </div>
                        <div class="sepH_c form-group">
                            <label for="s_email" class="col-md-2 control-label">E-mail:</label>
                            <div class="col-md-10">
								<input type="text" name="s_email" id="s_email" class="input-sm form-control">
							</div>
                        </div>
                    </fieldset>
