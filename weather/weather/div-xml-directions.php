...
<title>Google Maps Events | Demo: Simple Div with Directions with Geocoding</title>
<!--JAVASCRIPTS START-->
<!--map files-->
...
<script type="text/javascript" src="js/div-directions.js"></script>
<!--JAVASCRIPTS END-->
...
<div class="header">
Google Maps Events
<p>Demo: Simple Div with Directions with Geocoding</p>
</div>
