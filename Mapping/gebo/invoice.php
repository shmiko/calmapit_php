...
<html lang="en">
    ...
    <div class="col-sm-8 col-md-8">
		<h1 class="invoice_heading">Invoice #1234568</h1>
	</div>
	<div class="col-sm-4 col-md-4">
		<p class="sepH_a"><span class="sepV_b text-muted">Invoice No.</span><strong>12345678</strong></p>
		<p class="sepH_a"><span class="sepV_b text-muted">Invoice Date</span><strong>14/11/2012</strong></p>
		<p><span class="sepV_b text-muted">Payment Due</span><strong>24/11/2012</strong></p>
	</div>
</div>
<div class="row">
	<div class="col-sm-4 col-md-4">
		<p><strong class="text-muted">From</strong></p>
		<address>
	...
	<div class="col-sm-4 col-md-4">
		<p><strong class="text-muted">To</strong></p>
		<address>
			<strong>Lorem Ipsum, Inc.</strong><br>
			123 Lorem ipsum<br>
			Washington, WA 12345<br>
		</address>	
	</div>
</div>
<div class="row">
	<div class="col-sm-12 col-md-12">
		<table class="table">
			...
			<tbody><tr>
				...
				<td>$220.00</td>
				<td>1.00</td>
				<td class="invoice_tar">$220.00</td>
			</tr>
			<tr>
				<td>Lorem ipsum dolor...</td>
				<td>$134.00</td>
				<td>3.00</td>
				<td class="invoice_tar">$402.00</td>
			</tr>
			<tr>
				<td colspan="3">&nbsp;</td>
				<td class="invoice_tar">
					<p class="sepH_a"><span class="sepV_b text-muted">Subtotal</span>$622.00</p>
					<p class="sepH_a"><span class="sepV_b text-muted">Tax (10%)</span>$62.20</p>
					<p class="sepH_a"><span class="sepV_b text-muted">Discount</span>0</p>
					<p class="sepH_a text-success"><strong><span class="sepV_b">Total</span>$684.00</strong></p>
				</td>
			</tr>
		</tbody></table>
	</div>
...
<div class="row">
	<div class="col-sm-12 col-md-12">
		...
		<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum eget consectetur ante. Nunc vitae nunc vel elit imperdiet bibendum. Curabitur sagittis lobortis nibh lacinia tincidunt. Quisque ac elit est. Vivamus tempor risus ut nisl molestie nec consectetur lorem gravida. Nullam aliquam, felis id suscipit scelerisque, arcu metus ornare nunc, vitae fringilla augue urna id nisi. Vivamus dignissim laoreet dictum. In urna nisi, sagittis eu malesuada ac, lobortis euismod felis.</p>
	</div>
</div>                </div>
            </div>
