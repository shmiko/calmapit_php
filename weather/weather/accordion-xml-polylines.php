...
<title>Google Maps Events | Demo: Accordion with Polylines with Geocoding</title>
...
<div class="header">
Google Maps Events
<p>Demo: Accordion with Polylines with Geocoding</p>
</div>

<div class="outer">
<!--ACCORDION AND MAP START HERE-->
	<div class="accordionMap"><!--place for accordion here--></div>

	<div id="map"><!--place for map here--></div>

	<div class="clearfix"></div>
<!--ACCORDION AND MAP END HERE-->
...
<script type="text/javascript" src="js/accordion-polylines.js"></script>
