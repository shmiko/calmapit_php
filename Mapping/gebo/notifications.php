...
<html lang="en">
    ...
    <ul>
        ...
        <div class="col-sm-12 col-md-12">
            ...
            <div class="row">
                <div class="col-sm-2 col-md-2"><a href="javascript:void(0)" class="btn btn-default" id="sticky_a">Error</a></div>
                <div class="col-sm-2 col-md-2"><a href="javascript:void(0)" class="btn btn-default" id="sticky_b">Success</a></div>
                <div class="col-sm-2 col-md-2"><a href="javascript:void(0)" class="btn btn-default" id="sticky_c">Info</a></div>
                <div class="col-sm-2 col-md-2"><a href="javascript:void(0)" class="btn btn-default" id="sticky_d">Standard</a></div>
                <div class="col-sm-2 col-md-2"><a href="javascript:void(0)" class="btn btn-default" id="sticky_d_st">Sticky</a></div>
            </div>
            <div class="row">
                <div class="col-sm-2 col-md-2"><a href="javascript:void(0)" class="btn btn-default" id="sticky_e">Top Right</a></div>
                <div class="col-sm-2 col-md-2"><a href="javascript:void(0)" class="btn btn-default" id="sticky_f">Top Center</a></div>
                <div class="col-sm-2 col-md-2"><a href="javascript:void(0)" class="btn btn-default" id="sticky_g">Top Left</a></div>
                <div class="col-sm-2 col-md-2"><a href="javascript:void(0)" class="btn btn-default" id="sticky_h">Bottom Right</a></div>
                <div class="col-sm-2 col-md-2"><a href="javascript:void(0)" class="btn btn-default" id="sticky_i">Bottom Left</a></div>
            </div>
        </div>
    </div>
	<div class="row">
        <div class="col-sm-12 col-md-12">
            ...
            <div class="row">
                <div class="col-sm-2 col-md-2"><a href="javascript:void(0)" class="btn btn-default" id="smoke_signal">Signal</a></div>
                <div class="col-sm-2 col-md-2"><a href="javascript:void(0)" class="btn btn-default" id="smoke_alert">Alert</a></div>
                <div class="col-sm-2 col-md-2"><a href="javascript:void(0)" class="btn btn-default" id="smoke_confirm">Confirm</a></div>
                <div class="col-sm-2 col-md-2"><a href="javascript:void(0)" class="btn btn-default" id="smoke_prompt">Prompt</a></div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12 col-md-12">
			...
			<div class="row">
				<div class="col-sm-2 col-md-2"><a data-toggle="modal" data-backdrop="static" href="#myModal1" class="btn btn-default">Regular</a></div>
				<div class="col-sm-10 col-md-10">
					<p>trigger <code>&lt;a data-toggle="modal" data-backdrop="static" href="#myModal1"&gt;…&lt;/a&gt;</code></p>
					modal <code>&lt;div class="modal" id="myModal1"&gt;…&lt;/div&gt;</code>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-2 col-md-2"><a data-toggle="modal" data-backdrop="static" href="#myModal2" class="btn btn-default">Animated</a></div>
				<div class="col-sm-10 col-md-10">
					<p>trigger <code>&lt;a data-toggle="modal" data-backdrop="static" href="#myModal2"&gt;…&lt;/a&gt;</code></p>
					modal <code>&lt;div class="modal fade" id="myModal2"&gt;…&lt;/div&gt;</code>
				</div>
			</div>
			...
			<div class="modal" id="myModal1">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eveniet quos alias cum nostrum eos laudantium consectetur itaque temporibus accusamus aliquam quibusdam minus reprehenderit hic ad aspernatur neque repellat dicta dolore.
						</div>
						<div class="modal-footer">
