...
<pre class="prettyprint linenums">// Basic
&lt;table class="table"&gt;
...
&lt;/table&gt;
</pre>
		...
		<div class="row sepH_c">
			<div class="col-sm-4 col-md-4">
<pre class="prettyprint linenums">// Zebra-stripe
...
&lt;/table&gt;
		...
		<div class="row sepH_c">
			<div class="col-sm-4 col-md-4">
<pre class="prettyprint linenums">// Bordered
...
&lt;/table&gt;
		...
		<div class="row sepH_c">
			<div class="col-sm-4 col-md-4">
<pre class="prettyprint linenums">// Condensed
...
&lt;/table&gt;
		...
		<div class="row sepH_c">
			<div class="col-sm-4 col-md-4">
<pre class="prettyprint linenums">// Combined
...
&lt;/table&gt;
			...
			<div class="col-sm-8 col-md-8">
                ...
                <tbody>
                    <tr>
                        <td>134</td>
                        <td><a href="javascript:void(0)">Summer Throssell</a></td>
                        <td>summert@example.com</td>
                    </tr>
					<tr>
                        <td>135</td>
                        <td><a href="javascript:void(0)">Anthony Pound</a></td>
                        <td>anthonyp@example.com</td>
                    </tr>
					<tr>
                        <td>136</td>
                        <td><a href="javascript:void(0)">Erin Church</a></td>
                        <td>erinc@example.com</td>
                    </tr>
					<tr>
                        <td>137</td>
                        <td><a href="javascript:void(0)">Declan Pamphlett</a></td>
                        <td>declanp@example.com</td>
                    </tr>
                </tbody>
            </table>	
