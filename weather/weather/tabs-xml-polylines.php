...
<title>Google Maps Events | Demo: Tabs with Polylines with Geocoding</title>
...
var lineSymbol = {
	...
	scale : 1.7, //scale
	strokeColor : "#0080ff", //symbol color
}
...
<script type="text/javascript" src="js/tabs-polylines.js"></script>
<!--JAVASCRIPTS END-->
...
<div class="header">
Google Maps Events
<p>Demo: Tabs with Polylines with Geocoding</p>
</div>

<div class="outer">
<!--TABS AND MAP START HERE-->

	<div id="tabsMap">
		<div id="tabContent" class="content">
			<div class="content-wrapper"><!--place tabs here--></div>		
		</div>
		
		<div id="desc"><!--place description here--></div>
