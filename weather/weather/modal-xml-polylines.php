...
<title>Google Maps Events | Demo: Modal Window with Polylines with Geocoding</title>
...
var lineSymbol = {
	path : google.maps.SymbolPath.FORWARD_OPEN_ARROW, // symbol type, more here: https://developers.google.com/maps/documentation/javascript/overlays#PolylineSymbols
	strokeOpacity : 1, //opacity (set to zero (0) if you don't want show the lines symbols)
	scale : 1.7, //scale
	strokeColor : "#cc0000", //symbol color
}
...
var pOptions = {
	...
	geodesic : true,
	strokeColor : "#0080ff", //line color
	strokeOpacity : 0, //opacity (set to zero (0) if you don't want show the line)
	strokeWeight : 3,
	zIndex : 99,
	icons : [{
			icon : lineSymbol,
...
<script type="text/javascript" src="js/modal-polylines.js"></script>
<!--JAVASCRIPTS END-->
...
<div class="header">
Google Maps Events
<p>Demo: Modal Window with Polylines with Geocoding</p>
</div>

<div class="outer">
<!--MODAL AND MAP START HERE-->

	<div id="map"><!--place for map here--></div>

	<div id="modalMap"><!--place for modal here--></div>
	
<!--MODAL AND MAP END HERE-->
