...
<title>Google Maps Events | Demo: Accordion with Directions and Coordinates</title>
<!--JAVASCRIPTS START-->
<!--map files-->
...
<script src="js/accordion-coordinates-directions.js"></script>
<!--JAVASCRIPTS END-->
...
<div class="header">
Google Maps Events
<p>Demo: Accordion with Directions and Coordinates</p>
</div>
