...
<html lang="en">
    ...
    <div class="col-sm-12 col-lg-12">
        <p><button class="btn btn-default btn-sm" id="enable">Enable/Disable</button></p>
...
user!</a></td>
				...
				<tr>         
					...
					<td><a href="#" id="state2" data-type="typeaheadjs" data-pk="1" data-placement="right" data-original-title="Start typing State.."></a></td>
				</tr>                       
...
<div class="sidebar">
    ...
    <script src="lib/x-editable/inputs-ext/typeaheadjs/typeaheadjs.js"></script>
