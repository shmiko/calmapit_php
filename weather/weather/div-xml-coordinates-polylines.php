...
<title>Google Maps Events | Demo: Simple Div with Polylines and Coordinates</title>
...
var lineSymbol = {
	...
	strokeOpacity : 0.5, //opacity (set to zero (0) if you don't want show the lines symbols)
	scale : 1.7, //scale
...
<script type="text/javascript" src="js/div-coordinates-polylines.js"></script>
<!--JAVASCRIPTS END-->
...
<div class="header">
Google Maps Events
<p>Demo: Simple Div with Polylines and Coordinates</p>
</div>
