...
switch($extras_facebook_type){
	case 'photo':
		$out .= "<a href='$extras_facebook_link' target='_blank'><img class='nss-facebook-picture' src='$extras_facebook_image_320' alt='' border='0'></a>";
	...
	break;
	case 'video':
		$out .= "<iframe class='nss-facebook-video' width='200' height='150' src='$extras_facebook_source'></iframe>";
		$out .= "<div class='nss-facebook-name'>$extras_facebook_name</div>";
		$out .= "<div class='nss-facebook-message'>$extras_facebook_message</div>";
	break;
	case 'link':
		...
		$out .= "<div class='nss-facebook-name'>$extras_facebook_name</div>";
		$out .= "<div class='nss-facebook-description'>$extras_facebook_description</div>";
		if($extras_facebook_image_320) $out .= "<a href=\"$extras_facebook_link\" target='_blank'><img class='nss-facebook-picture' src='$extras_facebook_image_320' alt=\"$extras_facebook_link\" border='0'></a>";
