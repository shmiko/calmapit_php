...
<title>Google Maps Events | Demo: Accordion with Polylines and Coordinates</title>
...
<script type="text/javascript" src="js/accordion-coordinates-polylines.js"></script>
<!--JAVASCRIPTS END-->
...
<div class="header">
Google Maps Events
<p>Demo: Accordion with Polylines and Coordinates</p>
</div>
