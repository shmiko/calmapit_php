  ...
  gCalFlow = (function() {
    ...
    gCalFlow.prototype.gcal_url = function() {
      ...
      if (this.opts.feed_url) {
        ...
        return "https://www.google.com/calendar/feeds/" + this.opts.calid + "/public/full?alt=json-in-script&max-results=" + this.opts.maxitem + "&orderby=lastmodified&sortorder=descending&futureevents=true&singleevents=true";
      } else {
