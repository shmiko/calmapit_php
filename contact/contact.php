...
<html>
  ...
  <body id="top">
			...
			<div class="col-md-12">
				<div class="bs-example bs-example-tabs cstyle04">
					...
					if ($_POST["email"]<>'') {
					    ...
					    $MESSAGE_BODY = "Sent from titanicthemes.com<br/>";
					...
					<!-- THIS MESSAGE APPEARS AFTER YOU SEND THE EMAIL -->
					<form id="formID" class="contactform" method="post" action="#">
						<div class="tab-content">
							<!-- PUT YOUR MESSAGE SUCCESFYLY SENT HERE. -->
							<div class="alert alert-success" style="padding:5px;">
								<strong>Yes!</strong> Your message was successfully sent
								<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
							</div>
							<div class="col-md-4">
								<span class="opensans size24 slim">Contact</span>
								<input type="text" placeholder="Name" class="form-control logpadding margtop10" name="name">
								<input type="text" placeholder="Phone" class="form-control logpadding margtop20" name="phone">
								<input type="text" placeholder="E-mail" class="form-control logpadding margtop20" name="email">
							</div>
							<div class="col-md-4">
								<textarea rows="9" class="form-control margtop10" name="message"></textarea>
							</div>
						...
						<div class="searchbg3">
							<button type="submit" class="btn-search right mr20" value="Send Message">Send Email</button>
						</div>
					</form>
	...
	<script>
	  ...
	  ga('create', 'UA-50123757-1', 'titanicthemes.com');
	  ga('send', 'pageview');
	</script>		
  </body>
</html>
