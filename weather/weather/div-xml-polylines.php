...
<title>Google Maps Events | Demo: Simple Div with Polylines with Geocoding</title>
...
var lineSymbol = {
	...
	scale : 2, //scale
	strokeColor : "#cccccc", //symbol color
}
...
<script type="text/javascript" src="js/div-polylines.js"></script>
<!--JAVASCRIPTS END-->
...
<div class="header">
Google Maps Events
<p>Demo: Simple Div with Polylines with Geocoding</p>
</div>
