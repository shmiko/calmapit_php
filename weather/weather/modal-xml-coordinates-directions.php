...
<title>Google Maps Events | Demo: Modal Window with Directions and Coordinates</title>
<!--JAVASCRIPTS START-->
<!--map files-->
...
<script src="js/modal-coordinates-directions.js"></script>
<!--JAVASCRIPTS END-->
...
<div class="header">
Google Maps Events
<p>Demo: Modal Window with Directions and Coordinates</p>
</div>
<div class="outer">
