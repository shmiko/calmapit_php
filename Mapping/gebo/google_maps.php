			...
			<div class="col-sm-3 col-md-3" id="g-map-top">
                <div class="well">
					<form class="input-group" id="gmap_search">
						<input autocomplete="off" class="form-control" type="text" placeholder="Find location on map...">
		...
		<table class="table table-striped location_table">
			...
			<tbody>
				<tr>
					...
					<td>
						<div class="btn-group">
							<a href="javascript:void(0)" class="show_on_map btn btn-default btn-xs">Show</a>
							<a href="javascript:void(0)" class="comp_edit btn btn-default btn-xs">Edit</a>
						</div>
					</td>
				</tr>
				<tr>
