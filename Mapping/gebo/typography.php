...
<html lang="en">
    ...
    <div class="col-sm-6 col-md-6">
        <h3 class="heading">Blockquotes</h3>
        <div class="clearfix">
            <blockquote>
...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-6">
                <h3 class="heading">Horizontal Description</h3>
...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="row">
            <div class="col-sm-6 col-md-6">
                <h3 class="heading">Pre</h3>
<p><code>&lt;pre&gt;</code></p>
<pre class="sepH_c">if ( typeof target === "boolean" ) {
  deep = target;
  target = arguments[1] || {};
...
<p><code>&lt;pre class="prettyprint linenums"&gt;</code></p>
<pre class="prettyprint linenums">if ( typeof target === "boolean" ) {
  deep = target;
  target = arguments[1] || {};
  // skip the boolean and the target
  i = 2;
...
<p class="sepH_c"><code>&lt;body class="main_class"&gt;</code></p>
<p class="sepH_c"><code>if ( typeof target === "boolean" )</code></p>
<p class="sepH_c">Lorem ipsum <code>deep = target</code> dolor sit amet, porta felis euismod semper eget lacinia odio sem nec…</p>
