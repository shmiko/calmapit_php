                ...
                <div class="col-sm-8 col-md-8">
                    <div class="chat_content">
						...
						<div class="chat_editor_box">
							<textarea name="chat_editor" id="chat_editor" cols="30" rows="3" class="form-control"></textarea>
							<div class="btn-group send_btns">
								<a href="#" class="btn send_msg btn-default btn-xs">Send</a><a href="javascript:void(0)" class="btn enter_msg active btn-default btn-xs" data-toggle="button"><i class="icon-adt_enter"></i></a>
							</div>
							<input type="hidden" name="chat_user" id="chat_user" value="Johny Smith" class="form-control">
						</div>
					</div>
                </div>
                    ...
                    <div class="chat_sidebar">
						<div class="chat_heading clearfix">
							<div class="btn-group pull-right">
								<a href="#" class="btn ttip_t btn-default btn-xs" title="Refresh list"><i class="glyphicon glyphicon-refresh"></i></a>
								<a href="#" data-toggle="dropdown" class="dropdown-toggle btn ttip_t btn-default btn-xs" title="Options"><i class="glyphicon glyphicon-cog"></i></a>
								<ul class="dropdown-menu">
