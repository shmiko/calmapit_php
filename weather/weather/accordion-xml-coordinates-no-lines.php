...
<title>Google Maps Events | Demo: Accordion without Directions or Polylines (with Coordinates)</title>
<!--JAVASCRIPTS START-->
<!--map files-->
...
<script type="text/javascript" src="js/accordion-coordinates-no-lines.js"></script>
<!--JAVASCRIPTS END-->
...
<div class="header">
Google Maps Events
<p>Demo: Accordion without Directions or Polylines (with Coordinates)</p>
</div>
...
<br />Weather Maps (v. 1.2):<br /><a href="accordion-weather.php"> Accordion Weather</a><br />
</div>
