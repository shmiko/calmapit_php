...
<html lang="en">
    ...
    <div class="col-sm-6 col-md-6">
		<h3 class="heading">Validation with tooltips</h3>
		<form class="form_validation_ttip">
			<div class="formSep">
			...
			<div class="formSep">
				...
				<textarea name="your_message" id="your_message" cols="10" rows="3" class="form-control"></textarea>
			</div>
			<div class="formSep">
				<label><span class="error_placement">Checkboxes</span> <span class="f_req">*</span></label>
				<br>
				<label class="checkbox-inline">
					<input value="option1" name="days" type="checkbox"> Monday
				</label>
				<label class="checkbox-inline">
					<input value="option2" name="days" type="checkbox"> Tuesday
				</label>
				<label class="checkbox-inline">
					<input value="option3" name="days" type="checkbox"> Wednesday
				</label>
				<label class="checkbox-inline">
					<input value="option4" name="days" type="checkbox"> Thursday
				</label>
				<label class="checkbox-inline">
					<input value="option5" name="days" type="checkbox"> Friday
				</label>
			</div>
			<div class="formSep">	
				...
				<label class="radio-inline">
					<input value="option6" name="gender" type="radio">
					Male
				</label>
				<label class="radio-inline">
					<input value="option7" name="gender" type="radio">
					Female
				</label>
			</div>
    ...
    <div class="col-sm-6 col-md-6">
		<h3 class="heading">Regular validation</h3>
		<form class="form_validation_reg">
			<div class="formSep">
				<div class="row">
					<div class="col-sm-6 col-md-6">
						<label>First name <span class="f_req">*</span></label>
						<input name="reg_first_name" class="form-control" type="text">
						<span class="help-block">help block</span>
					</div>
					<div class="col-sm-6 col-md-6">
						<label>Last name <span class="f_req">*</span></label>
						<input name="reg_last_name" class="form-control" type="text">
					</div>
				</div>
			</div>
			<div class="formSep">
				<div class="row">
					<div class="col-sm-6 col-md-6">
						<label>City <span class="f_req">*</span></label>
						<input name="reg_city" class="form-control" type="text">
					</div>
					<div class="col-sm-6 col-md-6">
						<label>Zip Code</label>
						<input name="reg_zip" class="form-control" type="text">
					</div>
				</div>
			</div>
			<div class="formSep">
			...
			<div class="formSep">
					...
					<br>
					<label class="checkbox-inline">
						<input value="option1" name="reg_days" type="checkbox"> Monday
					</label>
					<label class="checkbox-inline">
						<input value="option2" name="reg_days" type="checkbox"> Tuesday
					</label>
					<label class="checkbox-inline">
						<input value="option3" name="reg_days" type="checkbox"> Wednesday
					</label>
					<label class="checkbox-inline">
						<input value="option4" name="reg_days" type="checkbox"> Thursday
					</label>
					<label class="checkbox-inline">
						<input value="option5" name="reg_days" type="checkbox"> Friday
					</label>
				</div>
				<div class="formSep">
					<label><span class="error_placement">Gender</span> <span class="f_req">*</span></label>
					<br>
					<label class="radio-inline">
						<input value="option6" name="reg_gender" type="radio">
						Male
					</label>
					<label class="radio-inline">
						<input value="option7" name="reg_gender" type="radio">
						Female
					</label>
				</div>
			</div>
