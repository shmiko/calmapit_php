...
<title>Google Maps Events | Demo: Tabs without Directions or Polylines (with Coordinates)</title>
<!--JAVASCRIPTS START-->
<!--map files-->
...
<script type="text/javascript" src="js/tabs-coordinates-no-lines.js"></script>
<!--JAVASCRIPTS END-->
...
<div class="header">
Google Maps Events
<p>Demo: Tabs without Directions or Polylines (with Coordinates)</p>
</div>
